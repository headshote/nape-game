	...
	public class FilteringInteractions extends Template 
	{
		...
		override protected function init():void 
		{
			...
			for (var i:uint = 0; i < 20; i++) 
			{
				...
				//if ( Math.random() > 0.5 && prevBoxBody )
				//{
					//var pivotPoint:Vec2 = Vec2.get(0,0);                
					//
					//var c:DistanceJoint = new DistanceJoint( boxBody, prevBoxBody, 
						//boxBody.worldPointToLocal(boxBody.position, true), 
						//prevBoxBody.worldPointToLocal(prevBoxBody.position, true),
						//100, 100
					//)
					//c.stiff = false;
					//c.frequency = 20.0;
			...
			for (i = 0; i < 20; i++) 
			{
				...
				//if ( i == 1 )
				//{
					//var anchP1:Vec2 = circleBody.position.copy(true);  
					//anchP1.x -= prevBoxBody.shapes.at(0).bounds.width;
					//anchP1.y -= prevBoxBody.shapes.at(0).bounds.width;
					//var anchP2:Vec2 = prevBoxBody.position.copy(true); 
					//
					//var c1:PivotJoint = new PivotJoint( circleBody, prevBoxBody, 
						//circleBody.worldPointToLocal(anchP1, true), 
						//prevBoxBody.worldPointToLocal(anchP2, true)
						//prevBoxBody.shapes.at(0).bounds.width, prevBoxBody.shapes.at(0).bounds.width
					//)
					//c1.stiff = false;
					//c1.frequency = 20.0;
					//c1.damping = 1.0;
